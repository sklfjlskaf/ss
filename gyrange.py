...
bot = telebot.TeleBot('7374759007:AAEMJtZ1u-ZL_5JCGNljNUTS3LRxDWj3WB4')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @BATLOADER9."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @BATLOADER9 ."
